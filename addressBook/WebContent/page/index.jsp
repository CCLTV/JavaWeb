...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		<div class="logo margin-big-left fadein-top">
			<h1>
				<img src="images/lo.jpg" class="radius-circle rotate-hover"
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			...
			<li><a href="../edituser.jsp" target="right"><span
		...
		<ul>
			<li><a href="../list.jsp" target="right"><span
					class="icon-caret-right"></span>电话簿</a></li>
			<li><a href="../add.jsp" target="right"><span
					class="icon-caret-right"></span>添加通讯簿</a></li>
		</ul>
